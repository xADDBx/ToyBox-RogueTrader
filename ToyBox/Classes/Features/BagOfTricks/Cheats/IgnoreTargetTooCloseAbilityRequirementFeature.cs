...
[HarmonyPatch, ToyBoxPatchCategory("ToyBox.Features.BagOfTricks.Cheats.IgnoreTargetTooCloseAbilityRequirementFeature")]
public partial class IgnoreTargetTooCloseAbilityRequirementFeature : FeatureWithPatch {
    ...
    protected override string HarmonyName {
        get {
            return "ToyBox.Features.BagOfTricks.Cheats.IgnoreTargetTooCloseAbilityRequirementFeature";
        }
    }
    ...
    private static void AbilityData_CanTargetFromNode_Patch(ref UnavailabilityReasonType? unavailabilityReason, AbilityData __instance, ref bool __result) {
        if (!__result && __instance.Caster is BaseUnitEntity unit && ToyBoxUnitHelper.IsPartyOrPet(unit) && unavailabilityReason == UnavailabilityReasonType.TargetTooClose) {
