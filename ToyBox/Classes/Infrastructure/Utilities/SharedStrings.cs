namespace ToyBox.Infrastructure.Utilities.Strings;

public static partial class SharedStrings {
    ...
    [LocalizedString("ToyBox_Infrastructure_Utilities_Strings_SharedStrings_TheCharacterPickerCannotBeUsedFromTheMainMenu", "The character picker cannot be used from the main menu!")]
    public static partial string TheCharacterPickerCannotBeUsedFromTheMainMenu { get; }
    ...
    [LocalizedString("ToyBox_Infrastructure_Utilities_Strings_SharedStrings_List_x_Matches", "Matches")]
    public static partial string MatchesText { get; }
