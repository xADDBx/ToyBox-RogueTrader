...
public abstract class ModFeature {
    private static readonly ConcurrentDictionary<Type, ModFeature> m_Instances = [];
    ...
    public static T GetInstance<T>() where T : ModFeature {
    ...
    public static T GetInstance<T>(Type t) where T : ModFeature {
